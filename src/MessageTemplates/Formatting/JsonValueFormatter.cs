// Copyright 2016 MessageTemplates Contributors
//
...
namespace MessageTemplates
{
    ...
    /// </summary>
    public class JsonValueFormatter : TemplatePropertyValueVisitor<TextWriter, bool>
    {
        ...
        /// the property name to use for the MessageTemplates <see cref="StructureValue.TypeTag"/> field
        ...
        public void Format(TemplatePropertyValue value, TextWriter output)
        {
