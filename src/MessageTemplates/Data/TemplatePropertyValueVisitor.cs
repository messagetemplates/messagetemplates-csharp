...
namespace MessageTemplates.Data
{
    ...
    /// <see cref="TemplatePropertyValue"/> format. Subclasses, by
    ...
    /// a node.</typeparam>
    public abstract class TemplatePropertyValueVisitor<TState, TResult>
    {
        /// <summary>
        ...
        protected virtual TResult Visit(TState state, TemplatePropertyValue value)
        {
        ...
        // ReSharper disable once VirtualMemberNeverOverriden.Global
        protected virtual TResult VisitUnsupportedValue(TState state, TemplatePropertyValue value)
        {
            if (value == null) throw new ArgumentNullException(nameof(value));
