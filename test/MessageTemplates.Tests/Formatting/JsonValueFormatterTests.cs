...
using System.IO;
using MessageTemplates.Formatting;
using MessageTemplates.Structure;
using Xunit;

namespace MessageTemplates.Tests.Formatting
{
    public class JsonValueFormatterTests
    {
        ...
        {
            var structure = new StructureValue(new[] { new TemplateProperty("A", new ScalarValue(123)) }, "T");
        ...
        {
            var structure = new StructureValue(new TemplateProperty[0], "T");
